...
module.exports = {
    ...
    execute(client) {
        ...
        const activities = [
            { name: 'Boo Family', type: ActivityType.Watching },
            { name: 'Vanlorant with Boarz', type: ActivityType.Playing },
            { name: 'Alissa Tien', type: ActivityType.Streaming },
            { name: 'Wrong times', type: ActivityType.Listening },
        ];
